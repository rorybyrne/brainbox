...
have already completed it. That workflow is backwards, and git should instead allow [preemptive commit messages](https://arialdomartini.wordpress.com/2012/09/03/pre-emptive-commit-comments/).
