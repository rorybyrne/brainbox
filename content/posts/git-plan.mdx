---
title: "git's code->stage->commit workflow is backwards"
date: "2021-03-28"
description: "Introducing a new tool that allows you to write preemptive commit messages"
---
...
The end result is that being "in the zone" is punished by git, and it leads to frustration and messy commits.

I recently built a tool called [git-plan](https://github.com/synek/git-plan) to tackle problem #1, by adding a new `git
